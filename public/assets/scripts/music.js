...
function load(abcString, sheetMusicId) {
    visualObj = ABCJS.renderAbc(sheetMusicId, abcString, { responsive: "resize" });
}

function activate(audioId = "audio", inlineAudioId = "abcjs-inline-audio") {
    if (ABCJS.synth.supportsAudio()) {
        ...
        midiBuffer.init({
            ...
            synthControl
                ...
                .then((response) => {
                    $(`.${inlineAudioId}`).removeClass("disabled");
                })
        });
    } else {
